...
namespace cimrman {
  ...
  private:
    ...
    std::vector<datamodel::TrackerHitHdl> tracker_hits;
    ...
    void add_hit_to_sinogram(datamodel::TrackerHitHdl & tracker_hit);
  ...
  public:
    ...
    void set_tracker_hits(const std::vector<datamodel::TrackerHitHdl> & _tracker_hits);
