...
namespace tkrec {
  ...
  {  
    ...
    double min_kink_angle = 30.0 * CLHEP::deg;
  ...
  private:
    ...
    // step 2: clustering
    void electron_clustering(PreclusterHdl precluster);
    void recursive_clusterizer(std::vector<TrackerHitHdl> & tracker_hits,
    ...
    void alpha_clustering(PreclusterHdl precluster);
    ...
    void make_MLM_fits(PreclusterHdl precluster);
    ...
    void combine_into_precluster_solutions(PreclusterHdl precluster);
    
    
    // step 5: Kink finding and connecting into polyline trajectories
    void create_polyline_trajectories(PreclusterHdl precluster);
    void create_line_trajectories(PreclusterHdl precluster, Trajectory::Type type);
    ...
    void refinements(PreclusterHdl precluster);
    void remove_wrong_hits_associations(PreclusterSolutionHdl & precluster_solution, TrajectoryHdl & trajectory);
    void connect_trajectories(PreclusterSolutionHdl & precluster_solution, KinkFinder::ConnectionStrategy strategy);
    void connect_trajectories(TrajectoryHdl base_trajectory, Trajectory::EndPoint base_endpoint, 
    ...
    void evaluate_trajectories(PreclusterHdl precluster);
    ...
    static bool compare_solutions(const SolutionHdl solution1, const SolutionHdl solution2);
