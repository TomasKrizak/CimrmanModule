...
namespace tkrec {
  ...
  AlphaCluster::AlphaCluster(const std::vector<ConstTrackerHitHdl> & _tracker_hits,
		       double _phi_min,
		       double _phi_max)
    : Cluster()
  {
  ...
  void AlphaCluster::set_phi_min(double _phi_min)
  {
    phi_min = _phi_min;
  }

  void AlphaCluster::set_phi_max(double _phi_max)
  {
    phi_max = _phi_max;
  }

  double AlphaCluster::get_phi_min() const
  {
    return phi_min;
  }

  double AlphaCluster::get_phi_max() const
  {
    return phi_max;
  }
  
  void AlphaCluster::set_center_x(double _center_x)
  {
    center_x = _center_x;
  }

  void AlphaCluster::set_center_y(double _center_y)
  {
    center_y = _center_y;
  }

  double AlphaCluster::get_center_x() const
  {
    return center_x;
  }

  double AlphaCluster::get_center_y() const
  {
    return center_y;
  }
  
  void AlphaCluster::set_reference_time_min(double _reference_time_min)
  {
    reference_time_min = _reference_time_min;
  }
  
  double AlphaCluster::get_reference_time_min() const
  {
    return reference_time_min;
  }

  void AlphaCluster::set_reference_time_max(double _reference_time_max)
  {
    reference_time_max = _reference_time_max;
  }
  
  double AlphaCluster::get_reference_time_max() const
  {
    return reference_time_max;
  }

  
  void AlphaCluster::set_reference_time(double _reference_time)
  {
    reference_time = _reference_time;
  }
  
  double AlphaCluster::get_reference_time() const
  {
    return reference_time;
  }
  
  // calculates the average x,y as the center of the cluster
  void AlphaCluster::find_center()
  {
  ...
  void AlphaCluster::update_drift_radii()
  { 
  ...
  void AlphaCluster::print(std::ostream & out_) const
  {
    out_ << "Alpha Cluster |"
