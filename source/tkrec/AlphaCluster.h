#ifndef FALAISE_CIMRMAN_ALPHACLUSTER_H
#define FALAISE_CIMRMAN_ALPHACLUSTER_H

#include "tkrec/Cluster.h"

namespace tkrec {

  class AlphaCluster : public Cluster
  {
  private:
  ...
  public:
    ...
    AlphaCluster() = default;		
    AlphaCluster(const std::vector<ConstTrackerHitHdl> & _tracker_hits,
		        double _phi_min,
		        double _phi_max,
		        double _r_min,
		        double _r_max);
  ...
  typedef std::shared_ptr<AlphaCluster> AlphaClusterHdl;
  typedef std::shared_ptr<const AlphaCluster> ConstAlphaClusterHdl;

} //  end of namespace tkrec

#endif // FALAISE_CIMRMAN_ALPHACLUSTER_H
